...
Client proposals for [Thinkswell](https://thinkswell.com), living at **proposal.thinkswell.com** — the same subdomain pattern as [analysis.thinkswell.com](https://analysis.thinkswell.com).

## What this is

- **Hub** (`/`) — internal index of every client proposal
- **Proposal** (`/p/[slug]`) — shareable, branded document the client can open
- **Template** (`/p/thinkswell-partnership`) — Thinkswell’s standard entertainment & hospitality partnership proposal
